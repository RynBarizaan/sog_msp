...
//////// set Rule of front of the Room ////
       ...
       saveProperties(){
         ...
         /////set Neighbores Status /////
          ...
          // @ts-ignore
          //this.listOfContacts[index]['AusnahmenVonNachbernAsBoolean'][this.listOfContacts[index]['AusnahmenVonNachbern'].length] =true;
          /*// @ts-ignore
      const found2 =  this.listOfContacts[index]['AusnahmenVonNachbern'].find((element: number) => element == (this.listOfContacts[this.index-1]['Vorname']+" "+this.listOfContacts[this.index-1]['Nachname']));
      if (!found2) {
      // @ts-ignore
      this.listOfContacts[index]['AusnahmenVonNachbern'][this.listOfContacts[index]['AusnahmenVonNachbern'].length] = this.listOfContacts[this.index - 1]['Vorname'] + " " + this.listOfContacts[this.index - 1]['Nachname'];
      }*/
      // @ts-ignore
